...
//           <button
//             className={`py-2 px-4 rounded font-semibold ${
//               searchOption === 'title' ? 'bg-accent-moonstone text-white' : 'bg-transparent border border-accent-moonstone text-accent-moonstone'
//             }`}
//             onClick={() => setSearchOption('title')}
//           >
//             By Title
...
//           <button
//             className={`py-2 px-4 rounded font-semibold ${
//               searchOption === 'author' ? 'bg-accent-moonstone text-white' : 'bg-transparent border border-accent-moonstone text-accent-moonstone'
//             }`}
//             onClick={() => setSearchOption('author')}
//           >
//             By Author
...
//           <button
//             className={`py-2 px-4 rounded font-semibold ${
//               searchOption === 'isbn' ? 'bg-accent-moonstone text-white' : 'bg-transparent border border-accent-moonstone text-accent-moonstone'
//             }`}
//             onClick={() => setSearchOption('isbn')}
//           >
//             By ISBN
...
//           <button
//             className={`py-2 px-4 rounded font-semibold ${
//               searchOption === 'book_id' ? 'bg-accent-moonstone text-white' : 'bg-transparent border border-accent-moonstone text-accent-moonstone'
//             }`}
//             onClick={() => setSearchOption('book_id')}
//           >
//             By Book ID
...
//             type="text"
//             placeholder={`Enter ${searchOption}`}
//             className="p-2 border border-gray-300 text-accent-raisin_black rounded w-full mb-4 mt-4"
//             value={searchValue}
//             onChange={(e) => setSearchValue(e.target.value)}
//           />
//         )}
...
// {/* Search Button */}
//         <button
//           className="text-accent-moonstone border border-accent-moonstone py-2 px-4 rounded font-semibold bg-transparent hover:border hover:text-accent-mindaro transition mt-4 mr-7"
//           onClick={handleSearch}
//         >
//           Search
//         </button>
